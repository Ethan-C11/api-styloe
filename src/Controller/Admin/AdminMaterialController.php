...
class AdminMaterialController extends AbstractController
{
    #[Route('/', name: 'app_admin_material_index', methods: ['GET'])]
    public function index(MaterialRepository $materialRepository): Response
    {
        return $this->render('admin_material/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_material/new.html.twig', [
            'material' => $material,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin_material/show.html.twig', [
            'material' => $material,
        ]);
    }
    ...
    public function edit(Request $request, Material $material, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_material/edit.html.twig', [
            'material' => $material,
            'form' => $form,
        ]);
    }
