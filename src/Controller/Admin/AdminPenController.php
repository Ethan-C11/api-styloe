...
class AdminPenController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_pen/new.html.twig', [
            'pen' => $pen,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin_pen/show.html.twig', [
            'pen' => $pen,
        ]);
    }
    ...
    public function edit(Request $request, Pen $pen, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_pen/edit.html.twig', [
            'pen' => $pen,
            'form' => $form,
        ]);
    }
